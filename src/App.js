...
function App() {
  ...
  // const url = `https://api.edamam.com/search?q=${query}&app_id=${process.env.REACT_APP_EDAMAM_ID}&app_key=${process.env.REACT_APP_EDAMAM_APP_KEY}&health=${healthLabel}`;
  ...
  return (
    <div className="app">
      <h1 onClick={getRecipeInfo}>
        <u>Recipe Hub</u><img src={CookingWoman} alt="cooking woman" />
      </h1>
      <form className="form" onSubmit={onSubmit}>
        <div className="search__form">
          ...
          <input type="submit" value="Get Recipe" className="search__form__submit" />
        </div>
      </form>
